...
;; (defun bk/show-current-tab-name ()
...
#+begin_src emacs-lisp :tangle ~/.config/emacs/init.el
;; (evil-define-key 'normal 'global
;;   (kbd "<leader>t.") 'tab-bar-select-tab-by-name
;;   (kbd "<leader>tc") 'bk/show-current-tab-name
;;   (kbd "<leader>tn") 'tab-bar-tab-name-function
;;   (kbd "<leader>tk") 'tab-close
;;   (kbd "<leader>tK") 'tab-close-other
;;   (kbd "<leader>tu") 'tab-bar-undo-close-tab
