...
(setq exwm-input-global-keys
      `(
        ...
        ([s-f2] . desktop-environment-volume-decrement)
        ([s-f3] . desktop-environment-volume-increment)

        ;; Volume control
        ;; ([s-f2] . (lambda ()
        ;;             (interactive) (start-process-shell-command "amixer" nil "amixer -q set Master 3%-")))
        ;; ([s-f3] . (lambda ()
        ;;             (interactive) (start-process-shell-command "amixer" nil "amixer -q set Master 3%+")))
        ;; ([s-f4] . (lambda ()
