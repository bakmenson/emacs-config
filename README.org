...
(setq exwm-input-global-keys
      `(
        ...
        ;; ([?\s-l] . (lambda ()
		;;     (interactive) (start-process "" nil "/usr/bin/slock")))

        ;; Volume control
        ([s-f2] . (lambda ()
                    (interactive) (start-process-shell-command "amixer" nil "amixer -q set Master 3%- unmute")))
        ([s-f3] . (lambda ()
                    (interactive) (start-process-shell-command "amixer" nil "amixer -q set Master 3%+ unmute")))
        ([s-f4] . (lambda ()
                    (interactive) (start-process-shell-command "amixer" nil "amixer -q set Master toggle")))
        ([s-f5] . (lambda ()
                    (interactive) (start-process-shell-command "amixer" nil "amixer -c 0 set 'Auto-Mute Mode' Disabled")))
        ([s-f6] . (lambda ()
                      (interactive) (start-process-shell-command "amixer" nil "amixer -c 0 set 'Auto-Mute Mode' Enabled")))))
#+end_src
...
(start-process-shell-command "picom" nil "picom --config ~/.config/picom.conf")
