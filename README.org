...
(setq-default minibuffer-line-format
              '("| "
                (:eval (propertize (format " ssd")
                                    'face '(:foreground "gray" :background "#282c34")))
                " | "
                (:eval (propertize (format " hdd")
                                    'face '(:foreground "gray" :background "#282c34")))
                " | "
                (:eval (propertize (format " mem")
                                    'face '(:foreground "gray" :background "#282c34")))
                " | "
                (:eval (propertize (format " cpu")
                                    'face '(:foreground "gray" :background "#282c34")))
                " | "
                (:eval (propertize (format " temp")
                                    'face '(:foreground "gray" :background "#282c34")))
                " | "
                (:eval (propertize (format " %s" (bk/get-current-volume))
                                    'face '(:foreground "gray" :background "#282c34")))
                " | "
                (:eval (propertize (format-time-string "%A, %d %B")
                                    'face '(:foreground "gray" :background "#282c34")))
                " | "
